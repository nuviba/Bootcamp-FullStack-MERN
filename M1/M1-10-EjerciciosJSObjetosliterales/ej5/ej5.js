...
/* 5. Vamos a hacer un generador de nombres de superhéroe. Pide al usuario la fecha de
...
let año=window.prompt('Dime tu año de nacimiento:');
...
let añosup;
let superhero;
let letraname=nombre[0];
let letrasurname=apellido[apellido.length-1];
let numaño='num'+año[año.length-1];
let sexo;


/* console.log(letraname);
 */
do{
  sexo=window.prompt('Si quieres nombre masculino introduce M si quieres femenino introduce F');
  sexo=sexo.toUpperCase();

}while(sexo!="M"&&sexo!="F");

if(sexo=="M"){
  nomsup=letraNombre[letraname].masculino;
  apsup=letraApellido[letrasurname].masculino;
  añosup=fechaNacimiento[numaño].masculino;

}
else if(sexo=="F"){
  nomsup=letraNombre[letraname].femenino;
  apsup=letraApellido[letrasurname].femenino;
  añosup=fechaNacimiento[numaño].femenino;
}
superhero=nomsup+" "+apsup+" "+añosup;

window.alert(`Tu nombre de super héroe/super heroina es ${superhero}`);
